...
class StatsApi
{
     ...
     * @return \Gethook\Model\StatsData
     */
     ...
     * @throws \Gethook\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Gethook\Model\StatsData, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Gethook\Model\StatsData';
        $request = $this->getStatsRequest($contentType);
