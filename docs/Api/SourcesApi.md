...
```php
listProviders(): \Gethook\Model\ProviderPreset[]
```
...
try {
    ...
    echo 'Exception when calling SourcesApi->listProviders: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Gethook\Model\ProviderPreset[]**](../Model/ProviderPreset.md)
